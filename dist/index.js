...
const nxUtils = __importStar(__nccwpck_require__(389));
/**
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.findNxProjectPath = void 0;
const find_file_1 = __nccwpck_require__(345);
async function findNxProjectPath() {
    const path = (0, find_file_1.findFile)('./', 'nx.json');
    if (!path)
        throw new Error('Failed to find Nx Workspace, searched for "nx.json"');
    return path;
}
exports.findNxProjectPath = findNxProjectPath;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getAffectedNxProjects = void 0;
const core = __importStar(__nccwpck_require__(186));
const child_process_1 = __nccwpck_require__(81);
async function getAffectedNxProjects(path, base) {
    const command = `npx -y nx show projects --affected --base="${base}"`;
    core.info(`Running command in ${path}: ${command}`);
    const projects = [];
    await new Promise((resolve, error) => (0, child_process_1.exec)(command, { cwd: path }, (err, stdout, stderr) => {
        if (err || stderr) {
            error(new Error(`Failed to get affected projects. Additional info:\n${JSON.stringify({ stdout, err, stderr }, null, 2)}`));
            return;
        }
...
exports.getAffectedNxProjects = getAffectedNxProjects;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(204), exports);
...
const fs = __importStar(__nccwpck_require__(147));
const path = __importStar(__nccwpck_require__(17));
function findFile(directoryPath, targetFileName) {
